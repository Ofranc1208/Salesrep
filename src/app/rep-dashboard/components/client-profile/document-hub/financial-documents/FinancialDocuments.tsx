...
const FinancialDocuments: React.FC<FinancialDocumentsProps> = ({ 
  searchTerm, 
  onUploadDocument 
}) => {
  const category = documentCategories.financial;
  const categoryDocuments = mockDocuments.filter(doc => doc.category === 'financial');
